...
const Tabs = React.forwardRef<HTMLDivElement, TabsProps>(({ className, tabs, activeTab, onTabChange, ...props }, ref) => {
            ...
            <div className="relative">
                ...
                <div className="relative flex space-x-[6px] items-center">
                    {tabs.map((tab, index) => (
                        ...
                        >
                            <div className="text-sm font-medium leading-5 whitespace-nowrap flex items-center justify-center h-full">{tab.label}</div>
                        </div>
                    ))}
                </div>
            </div>
