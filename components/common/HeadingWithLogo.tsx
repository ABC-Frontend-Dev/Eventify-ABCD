...
export default function HeadingWithLogo({ titlePart1, titlePart2_1, titlePart2_2 }: HeadingWithoutLogoProps) {
    return (
        <h2 className="mb-3 lg:mb-3 text-2xl lg:text-4xl tracking-widest font-medium font-helvetica uppercase border-b-2 border-slate-800 w-fit text-slate-800 flex flex-row items-center justify-center gap-2.5">
            {titlePart1}{" "}
