...
export default function Teams() {
    ...
    return (
        <div className="relative hidden lg:grid grid-cols-10 grid-rows-7 gap-x-1.5 gap-y-1">
            <GridItem member={teamMembers[0]} />
            <GridItem member={teamMembers[1]} className="col-start-1 row-start-2" />
            <div className="col-start-1 row-start-3"></div>
            <GridItem member={teamMembers[2]} className="col-start-1 row-start-4" />
            <GridItem member={teamMembers[3]} className="col-span-2 row-span-2 col-start-1 row-start-5" showCaption />
            <div className="col-start-1 row-start-7"></div>

            <GridItem member={teamMembers[4]} className="col-start-2 row-start-1" />
            <GridItem member={teamMembers[5]} className="col-start-2 row-start-2 translate-y-9" />
            <GridItem member={teamMembers[6]} className="col-start-2 row-start-3 translate-y-9" />
            ...
            <GridItem member={teamMembers[7]} className="col-start-3 row-start-2" />
            <GridItem member={teamMembers[8]} className="col-start-3 row-start-3" />
            <GridItem member={teamMembers[9]} className="col-start-3 row-start-4" />
            <GridItem member={teamMembers[10]} className="col-start-3 row-start-5" />
            <div className="col-start-3 row-start-6"></div>
            <div className="col-start-3 row-start-7"></div>

            <GridItem member={teamMembers[11]} className="col-start-4 row-start-1" />
            <GridItem member={teamMembers[12]} className="col-start-4 row-start-2" />
            <GridItem member={teamMembers[13]} className="col-span-3 row-span-3 col-start-4 row-start-3 translate-y-9" showCaption />
            <div className="col-start-4 row-start-6"></div>
            <GridItem member={teamMembers[14]} className="col-start-4 row-start-7" />

            <GridItem member={teamMembers[15]} className="col-start-5 row-start-1" />
            <GridItem member={teamMembers[16]} className="col-start-5 row-start-2 translate-y-9" />
            <div className="col-start-5 row-start-6"></div>
            <GridItem member={teamMembers[17]} className="col-start-5 row-start-7" />

            <div className="col-start-6 row-start-1"></div>
            <GridItem member={teamMembers[18]} className="col-start-6 row-start-2 translate-y-9" />
            <div className="col-start-6 row-start-6"></div>
            <GridItem member={teamMembers[19]} className="col-start-6 row-start-7" />

            <GridItem member={teamMembers[20]} className="col-start-7 row-start-1" />
            <div className="col-start-7 row-start-2"></div>
            <GridItem member={teamMembers[21]} className="col-span-2 row-span-2 col-start-7 row-start-3" showCaption />
            <GridItem member={teamMembers[22]} className="col-start-7 row-start-5" />
            <GridItem member={teamMembers[23]} className="col-start-7 row-start-6" />
            <div className="col-start-7 row-start-7"></div>

            <GridItem member={teamMembers[24]} className="col-start-8 row-start-1" />
            <GridItem member={teamMembers[25]} className="col-start-8 row-start-2" />
            <GridItem member={teamMembers[26]} className="col-start-8 row-start-5" />
            <GridItem member={teamMembers[27]} className="col-span-2 row-span-2 col-start-8 row-start-6" showCaption />

            <div className="col-start-9 row-start-1"></div>
            <GridItem member={teamMembers[28]} className="col-start-9 row-start-2" />
            <GridItem member={teamMembers[29]} className="col-start-9 row-start-3" />
            <GridItem member={teamMembers[30]} className="col-span-2 row-span-2 col-start-9 row-start-4" showCaption />

            <GridItem member={teamMembers[31]} className="col-start-10 row-start-1" />
            <div className="col-start-10 row-start-2"></div>
            <GridItem member={teamMembers[32]} className="col-start-10 row-start-3" />
            <GridItem member={teamMembers[33]} className="col-start-10 row-start-6" />
            <GridItem member={teamMembers[34]} className="col-start-10 row-start-7" />
