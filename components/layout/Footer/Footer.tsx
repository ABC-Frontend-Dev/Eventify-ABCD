            ...
            <div className="max-w-360 w-full mx-auto px-5 lg:px-20 py-4.5 lg:py-9">
                ...
                <div className="mt-8 lg:mt-20.75 flex items-start justify-between">
                    <div className="flex justify-between items-end w-full">
                        <div className="w-full text-4xl md:text-7xl lg:text-[85px] xl:text-[154px] text-white leading-10 md:leading-19 lg:leading-22.25 xl:leading-39 font-helvetica-heavy font-extrabold uppercase flex gap-x-1 xs:gap-x-1.5 xl:gap-x-7 lg:flex items-start md:items-center flex-wrap">
                            <div>lets</div>
                            <div className="flex items-center gap-0">
                                <span>ev </span>
                                <span className="block w-10 md:w-20 xl:w-34 h-12 md:h-20 xl:h-36 -translate-y-3.5">
                                    <Image
...
function InstagramIcon() {
    return (
        <svg viewBox="0 0 24 24" className="w-3 md:w-11 h-3 md:h-11 fill-white stroke-white" strokeWidth={0.25} strokeLinecap="round" strokeLinejoin="round">
...
function LinkedInIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-3 md:w-11 h-3 md:h-11 fill-white stroke-white" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round">
