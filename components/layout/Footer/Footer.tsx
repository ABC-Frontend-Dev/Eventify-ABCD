    ...
    return (
        <footer className="bg-footer-bg">
            <div className="max-w-360 w-full mx-auto px-5 lg:px-20 py-4.5 lg:py-9">
                ...
                <div className="mt-8 lg:mt-13 text-white">
                    ...
                    <div className="mt-3 lg:mt-11 flex items-start flex-col sm:flex-row justify-between w-full">
                        <div className="flex items-start flex-col sm:flex-row gap-5.25 w-full shrink xl:shrink-0">
                            <div className="flex flex-col sm:flex-row w-full md:w-1/2 gap-0 md:gap-5.25 shrink-0">
                            ...
                            <div className="w-full md:w-1/2 flex justify-end">
                                <div className="w-full xl:w-[450px]">
                                    <p className="text-3xl md:text-[35px] font-abc-laica-a-italic-variable-trial leading-10 mb-1.5 md:mb-7">Join our Newsletter</p>
                ...
                <div className="mt-8 lg:mt-20.75 flex items-start justify-between">
                    <div className="flex justify-between items-end w-full">
                        <div className="w-full text-4xl md:text-7xl lg:text-[85px] xl:text-[154px] text-white leading-10 md:leading-19 lg:leading-22.25 xl:leading-39 font-helvetica-heavy font-extrabold uppercase flex gap-1 xs:gap-x-1.5 xl:gap-x-7 lg:flex items-start md:items-center flex-wrap">
                            <div>lets</div>
                            <div className="flex items-end justify-between w-full lg:w-fit">
                                <div className="flex items-center gap-0">
                                    <span>ev </span>
                                    <span className="block w-9 md:w-20 xl:w-34 h-9 md:h-20 xl:h-36 -translate-y-1.25 md:-translate-y-3.5">
                                        <Image
...
function FacebookIcon() {
    return (
        <svg viewBox="0 0 24 24" className="w-5 md:w-9 h-5 md:h-9 fill-white md:-translate-y-1">
...
function InstagramIcon() {
    return (
        <svg viewBox="0 0 24 24" className="w-5 md:w-7 h-5 md:h-7 fill-white stroke-white" strokeWidth={0.25} strokeLinecap="round" strokeLinejoin="round">
...
function LinkedInIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 md:w-7.5 h-5 md:h-7.5 fill-white stroke-white" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round">
