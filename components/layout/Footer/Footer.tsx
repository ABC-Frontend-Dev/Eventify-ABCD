        ...
        <footer className="bg-footer-bg">
            <div className="max-w-360 w-full mx-auto px-5 lg:px-20 py-9">
                ...
                <div className="mt-8 lg:mt-20.75 text-white">
                    ...
                    <div className="mt-5 flex items-start gap-5.25 max-w-5xl w-full">
                        <div className="w-1/2">
                ...
                <div className="mt-8 lg:mt-20.75 text-white">
                    <div className="flex items-center justify-between">
                        <h2 className="text-xl lg:text-2xl font-helvetica leading-6 lg:leading-7.5 uppercase">
                            Contact us
                            <span className="ml-4.75 font-product-sans-regular text-xl leading-7 tracking-wider">
                        ...
                        {/* Social icons with GSAP hover animation */}
