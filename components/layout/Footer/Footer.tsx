            ...
            <div className="max-w-360 w-full mx-auto px-5 lg:px-20 py-9">
                ...
                <div className="mt-8 lg:mt-20.75 text-white">
                    ...
                    <div className="mt-5 flex items-start gap-5.25">
                        <div>
                            <h2 className="text-xl lg:text-2xl font-helvetica-bold tracking-[1.5px] font-bold leading-6 lg:leading-7.5 uppercase mb-2">uae</h2>
                            <h3 className="text-base lg:text-xl font-helvetica-medium tracking-[1px] font-bold leading-5 lg:leading-6 mb-2.25">Address:</h3>
                            <p className="text-xs lg:text-xl font-product-sans-light font-light leading-4 lg:leading-6 tracking-wide mb-2.25">
                                508, API Business Suite, Al Barsha 1, PO Box 449832, Dubai, UAE
                            </p>
                        </div>
                        <div>
                            <h2 className="text-xl lg:text-2xl font-helvetica-bold tracking-[1.5px] font-bold leading-6 lg:leading-7.5 uppercase mb-2">ksa</h2>
                            <h3 className="text-base lg:text-xl font-helvetica-medium tracking-[1px] font-bold leading-5 lg:leading-6 mb-2.25">Address:</h3>
                            <p className="text-xs lg:text-xl font-product-sans-light font-light leading-4 lg:leading-6 tracking-wide mb-2.25">
                ...
                <div className="mt-8 lg:mt-20.75 text-white">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-5">
                            ...
                            <div className="">
                                <Link href="https://www.linkedin.com/company/eventifyentertainment/" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                    ...
                    <div className="mt-2.5 flex items-start gap-5.25">
                        <div className="hidden text-8xl lg:text-[155px] leading-41.25 font-helvetica-heavy font-extrabold uppercase lg:flex lg:items-start">
