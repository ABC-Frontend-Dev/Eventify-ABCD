        ...
        <footer className="bg-footer-bg">
            <div className="max-w-360 w-full mx-auto px-5 lg:px-20 py-4.5 lg:py-9">
                ...
                <div className="mt-8 lg:mt-20.75 text-white">
                    ...
                    <div className="mt-5 flex items-start flex-col sm:flex-row justify-between w-full">
                        <div className="flex items-start flex-col sm:flex-row gap-5.25 max-w-5xl w-full shrink-0">
                            <div className="w-full sm:w-1/2">
                                <p className="text-lg lg:text-2xl font-helvetica-bold tracking-[1.5px] font-bold leading-6 lg:leading-7.5 uppercase mb-1 lg:mb-2">uae</p>
                            ...
                            <div className="w-full sm:w-1/2">
                                <p className="text-lg lg:text-2xl font-helvetica-bold tracking-[1.5px] font-bold leading-6 lg:leading-7.5 uppercase mb-1 lg:mb-2">ksa</p>
                ...
                {/* <div className="mt-8 lg:mt-20.75 text-white">
                    <div className="hidden md:flex items-center justify-between">
                        <p className="text-xl lg:text-2xl font-helvetica leading-6 lg:leading-7.5 uppercase">
                            Contact us
                ...
                <div className="mt-8 lg:mt-20.75 flex items-start gap-5.25">
