...
function FacebookIcon() {
    return (
        <svg viewBox="0 0 24 24" className="w-5 md:w-6 h-5 md:h-6" fill="currentColor">
...
function InstagramIcon() {
    return (
        <svg viewBox="0 0 24 24" className="w-4 md:w-5 h-4 md:h-5 stroke-footer-bg" strokeWidth={0.25} strokeLinecap="round" strokeLinejoin="round">
