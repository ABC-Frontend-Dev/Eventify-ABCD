...
// Images for WOW Awards carousel
const tabs2024Content1CarouselImages = [
    "/images/awards/wow-awards.png",
    "/images/awards/wow-awards.png",
    "/images/awards/wow-awards.png",
    "/images/awards/wow-awards.png",
...
// Images for Middle East Event Awards carousel
const tabs2024Content2CarouselImages = [
    "/images/awards/middle-east-event-award.png",
    "/images/awards/middle-east-event-award.png",
    "/images/awards/middle-east-event-award.png",
    "/images/awards/middle-east-event-award.png",
...
const tabs2024 = [
    {
        ...
        content: (
            <div className="relative">
                {/* Carousel */}
                <Carousel.Root defaultPage={0} slideCount={tabs2024Content1CarouselImages.length} autoplay={{ delay: 2500 }} className="w-full">
                    <Carousel.ItemGroup className="">
                        {tabs2024Content1CarouselImages.map((image, index) => (
                            <Carousel.Item key={index} index={index}>
                                <img src={image} alt={`WOW Awards Slide ${index + 1}`} className="w-full h-full object-cover" />
                            </Carousel.Item>
                        ))}
                    ...
                    {/* Optional: Add indicators */}
                    {/* <Carousel.IndicatorGroup className="flex justify-center items-center mt-4 gap-2">
                        {tabs2024Content1CarouselImages.map((_, index) => (
                            <Carousel.Indicator key={index} index={index} className="w-2 h-2 rounded-full bg-white/30 data-current:bg-white transition-colors cursor-pointer" />
                        ))}
                    </Carousel.IndicatorGroup> */}
                </Carousel.Root>
    ...
    },
    {
        ...
        content: (
            <div className="relative">
                {/* Carousel */}
                <Carousel.Root defaultPage={0} slideCount={tabs2024Content2CarouselImages.length} autoplay={{ delay: 2500 }} className="w-full">
                    <Carousel.ItemGroup className="overflow-hidden">
                        {tabs2024Content2CarouselImages.map((image, index) => (
                            <Carousel.Item key={index} index={index}>
                                <img src={image} alt={`Middle East Event Awards Slide ${index + 1}`} className="w-full h-auto object-cover" />
                            </Carousel.Item>
                        ))}
                    ...
                    {/* Optional: Add indicators */}
                    {/* <Carousel.IndicatorGroup className="flex justify-center items-center mt-4 gap-2">
                        {tabs2024Content2CarouselImages.map((_, index) => (
                            <Carousel.Indicator key={index} index={index} className="w-2 h-2 rounded-full bg-white/30 data-current:bg-white transition-colors cursor-pointer" />
                        ))}
                    </Carousel.IndicatorGroup> */}
                </Carousel.Root>
...
export function AwardsTabContent2024() {
    return (
        <AwardsTabs defaultValue="wow-awards-middle-east-2024">
            <AwardsTabsList>
                {tabs2024.map((tab) => (
