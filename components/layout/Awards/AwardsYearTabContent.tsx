    ...
    return (
        <div className="relative h-full">
            ...
            {currentImage && (currentImage.title || currentImage.description) && (
                <div className="absolute left-1.5 lg:left-7.5 bottom-1 lg:bottom-10 z-20 max-w-44 w-full sm:max-w-120 md:min-w-61.25">
...
export default function AwardsYearTabContent({ categories }: AwardsYearTabContentProps) {
    ...
    return (
        <AwardsTabs defaultValue={defaultValue}>
            <div className="absolute right-1.25 sm:right-14 bottom-2 sm:bottom-10 z-100">
