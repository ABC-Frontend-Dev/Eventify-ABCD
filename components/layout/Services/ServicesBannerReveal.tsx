...
interface ServicesBannerRevealProps {
    desktopSrc: string;
    mobileSrc: string;
    alt: string;
}

export default function ServicesBannerReveal({ desktopSrc, mobileSrc, alt }: ServicesBannerRevealProps) {
    ...
    return (
        <div className="max-w-max w-full h-68.5 lg:h-105">
