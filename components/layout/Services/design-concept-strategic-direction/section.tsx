...
export default function DesignConceptStrategicDirection() {
    useEffect(() => {
    ...
    playsInline
    preload="metadata"
    poster="https://res.cloudinary.com/afdhm38k/image/upload/v1787832987/design-concept-strategic-direction_frame_ze2fvr.jpg"
>
    <source
        src="https://res.cloudinary.com/afdhm38k/video/upload/v1787832702/design-concept-strategic-direction_vlrf23.mp4"
        type="video/mp4"
    />
    Your browser does not support the video tag.
</video>
                </div>
                <SectionPageHeader title={"Design Concept & Strategic Direction"} description="We transform ideas into immersive event concepts through strategic planning, creative storytelling, and innovative design direction. Every detail is carefully considered to ensure your event delivers a memorable and meaningful experience."/>
            </div>
        </section>
    );
}
