                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="border-slate-200 hover:bg-slate-50/50">
                                ...
                                <TableHead className="font-semibold text-slate-700 min-w-[200px]">Name</TableHead>
                                <TableHead className="font-semibold text-slate-700 min-w-[300px]">Description</TableHead>
